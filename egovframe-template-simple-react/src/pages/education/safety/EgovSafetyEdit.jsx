...
function EgovSafetyEdit(props) {
    console.group("EgovSafetyEdit");
    console.log("------------------------------");
    console.log("EgovSafetyEdit [props] : ", props);

    const navigate = useNavigate();
    const location = useLocation();
    console.log("EgovSafetyEdit [location] : ", location);
            ...
            EgovNet.requestFetch(modeInfo.editURL,
                ...
                (resp) => {
                    if (Number(resp.resultCode) === Number(CODE.RCV_SUCCESS)) {
                        navigate(URL.EDUCATION_SAFETY, {state:{bbsId : bbsId}});
                    } else {
    ...
    console.groupEnd("EgovSafetyEdit");
                        ...
                        <div className="board_view2">
                            ...
                            <div className="board_btn_area">
                                ...
                                <div className="right_col btn1">
                                    <Link to={URL.EDUCATION_SAFETY} className="btn btn_blue_h46 w_100">목록</Link>
                                </div>
                            </div>
                            {/* <!--// 버튼영역 --> */}
                        </div>
