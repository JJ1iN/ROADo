...
function EgovSafetyList(props) {
    console.group("EgovSafetyList");
    console.log("[Start] EgovSafetyList ------------------------------");
    console.log("EgovSafetyList [props] : ", props);

    const location = useLocation();
    console.log("EgovSafetyList [location] : ", location);
    ...
    const retrieveList = useCallback((searchCondition) => {
        console.groupCollapsed("EgovSafetyList.retrieveList()");
        ...
        EgovNet.requestFetch(retrieveListURL,
            ...
            (resp) => {
                ...
                resp.result.resultList.forEach(function (item, index) {
                    ...
                    mutListTag.push(
                        <Link
                            to={{pathname: URL.EDUCATION_SAFETY_DETAIL}}
                            state={{
                                nttId: item.nttId,
                                bbsId: item.bbsId,
        ...
        console.groupEnd("EgovSafetyList.retrieveList()");
    },[]);
    ...
    console.log("------------------------------EgovSafetyList [End]");
    console.groupEnd("EgovSafetyList");
    return (
            ...
            <div className="c_wrap">
                ...
                <div className="layout">
                    ...
                    <div className="contents NOTICE_LIST" id="contents">
                        ...
                        <h2 className="tit_2">교통안전사회교육</h2>
