...
function EgovSafetyDetail(props) {
    console.group("EgovSafetyDetail");
    console.log("------------------------------");
    console.log("EgovSafetyDetail [props] : ", props);

    const navigate = useNavigate();
    const location = useLocation();
    console.log("EgovSafetyDetail [location] : ", location);
        ...
        EgovNet.requestFetch(deleteBoardURL,
            ...
            (resp) => {
                ...
                if (Number(resp.resultCode) === Number(CODE.RCV_SUCCESS)) {
                    alert("게시글이 삭제되었습니다.")
                    navigate(URL.EDUCATION_SAFETY ,{ replace: true });
                } else {
    ...
    console.groupEnd("EgovSafetyDetail");
            ...
            <div className="c_wrap">
                ...
                <div className="location">
                    <ul>
                        ...
                        <li><Link to={URL.EDUCATION_SPECIAL}>교통안전사회교육</Link></li>
                ...
                <div className="layout">
                    ...
                    <div className="contents NOTICE_VIEW" id="contents">
                        ...
                        <div className="top_tit">
                            <h1 className="tit_1">교통안전사회교육</h1>
                        </div>
                            ...
                            <div className="board_btn_area">
                                {user.id && masterBoard.bbsUseFlag === 'Y' &&
                                    <div className="left_col btn3">
                                        <Link to={{pathname: URL.EDUCATION_SAFETY_MODIFY}}
                                            state={{
                                                nttId: nttId,
                                                bbsId: bbsId
                                            }}
                                        ...
                                        <Link to={{pathname: URL.EDUCATION_SAFETY_REPLY}}
                                            state={{
                                                nttId: nttId,
                                                bbsId: bbsId
                                            }}
                                ...
                                <div className="right_col btn1">
                                    <Link to={{pathname: URL.EDUCATION_SAFETY}}
                                        state={{
                                            nttId: nttId,
                                            bbsId: bbsId,
...
export default EgovSafetyDetail;