...
function EgovSpecialEdit(props) {
    console.group("EgovSpecialEdit");
    console.log("------------------------------");
    console.log("EgovSpecialEdit [props] : ", props);

    const navigate = useNavigate();
    const location = useLocation();
    console.log("EgovSpecialEdit [location] : ", location);
            ...
            EgovNet.requestFetch(modeInfo.editURL,
                ...
                (resp) => {
                    if (Number(resp.resultCode) === Number(CODE.RCV_SUCCESS)) {
                        navigate(URL.EDUCATION_SPECIAL, {state:{bbsId : bbsId}});
                    } else {
    ...
    console.groupEnd("EgovSpecialEdit");
                        ...
                        <div className="board_view2">
                            ...
                            <div className="board_btn_area">
                                ...
                                <div className="right_col btn1">
                                    <Link to={URL.EDUCATION_SPECIAL} className="btn btn_blue_h46 w_100">목록</Link>
                                </div>
                            </div>
                            {/* <!--// 버튼영역 --> */}
                        </div>
...
export default EgovSpecialEdit;