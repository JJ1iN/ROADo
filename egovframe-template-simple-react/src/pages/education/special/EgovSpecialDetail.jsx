...
function EgovSpecialDetail(props) {
    console.group("EgovSpecialDetail");
    console.log("------------------------------");
    console.log("EgovSpecialDetail [props] : ", props);

    const navigate = useNavigate();
    const location = useLocation();
    console.log("EgovSpecialDetail [location] : ", location);
        ...
        EgovNet.requestFetch(deleteBoardURL,
            ...
            (resp) => {
                ...
                if (Number(resp.resultCode) === Number(CODE.RCV_SUCCESS)) {
                    alert("게시글이 삭제되었습니다.")
                    navigate(URL.EDUCATION_SPECIAL ,{ replace: true });
                } else {
    ...
    console.groupEnd("EgovSpecialDetail");
                            ...
                            <div className="board_btn_area">
                                {user.id && masterBoard.bbsUseFlag === 'Y' &&
                                    <div className="left_col btn3">
                                        <Link to={{pathname: URL.EDUCATION_SPECIAL_MODIFY}}
                                            state={{
                                                nttId: nttId,
                                                bbsId: bbsId
                                            }}
                                        ...
                                        <Link to={{pathname: URL.EDUCATION_SPECIAL_REPLY}}
                                            state={{
                                                nttId: nttId,
                                                bbsId: bbsId
                                            }}
                                ...
                                <div className="right_col btn1">
                                    <Link to={{pathname: URL.EDUCATION_SPECIAL}}
                                        state={{
                                            nttId: nttId,
                                            bbsId: bbsId,
...
export default EgovSpecialDetail;